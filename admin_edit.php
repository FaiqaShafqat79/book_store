...
?>
	...
	<form method="post" action="edit_book.php" enctype="multipart/form-data">
		<table class="table">
			...
			<tr>
				<th>Description</th>
				<td><textarea name="descr" cols="40" rows="5"><?php echo $row['book_desr'];?></textarea>
			</tr>
			<tr>
				<th>Price</th>
			...
			<tr>
				<th>Publisher</th>
				<td><input type="text" name="publisher" value="<?php echo getPubName($conn, $row['id']); ?>" required></td>
			</tr>
		</table>
